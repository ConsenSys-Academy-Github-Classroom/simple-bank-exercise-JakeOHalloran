...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      require(enrolled[msg.sender] == true, "user must be enrolled before deposits can be made");
      // or did you want me to call enroll() ? doesnt make sense to do this on every deposit call i dont think?
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require(balances[msg.sender] >= withdrawAmount, "user must be enrolled before deposits can be made");
